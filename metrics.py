    ...
    for latency in latencies:
        ...
        for wf in wait_fractions:
            ...
            for i in range(num_tries):
                ...
                mcf_hist_array = np.append(mcf_hist_array, (mcsum-prev_mc_sum)/len(validators)/NUM_EPOCH/EPOCH_SIZE)
                prev_mc_sum = mcsum
            ...
            print("MCF hist array:{}".format(mcf_hist_array))
            mcf_hist = np.histogram(mcf_hist_array, bins = 10, density=True)
            print("MCF hist:{}".format(mcf_hist))
            print('=== Statistics ===')
            print('Latency: {}'
                    .format(latency))
            print('Timing: {}'
